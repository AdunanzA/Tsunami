...
public:
   ...
   */
//    typedef std::tuple<qreal, qreal, QColor> Segment;
...
//    };
    class Segment
    {
      public:
        ...
        {  }
        Segment(const Segment &c):
          first(c.first),
          second(c.second),
          color(c.color)
        {  }
        Segment(qreal a, qreal b, QColor c):
            first(a),
            second(b),
            color(c)
        {  }
...
public slots:
   ...
   */
  void addSegment(int cyl, qreal startAngle, qreal stopAngle, QColor color);
